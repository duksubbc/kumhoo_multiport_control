...
#define __STM8L15X_STDPERIPH_VERSION_SUB2   ((uint8_t)0x01) 
...
#define SYSCFG_RMPCR2_TIM3TRIG_REMAP    ((uint8_t)0x04) /*!< TIM3 Trigger remap */
...
#define WFE_CR2_EXTI_EVD      ((uint8_t)0x20)
#define WFE_CR2_EXTI_EVB      ((uint8_t)0x10)
...
/* SWTRIGR*/
#define DAC_SWTRIGR_SWTRIG    ((uint8_t)0x01) /*!<  DAC channel software trigger. */
...
#define SYSCFG_BASE                 (uint16_t)0x509E
...
#define SWIM_BASE                   (uint16_t)0x7F80
